...
class KokoroProvider(TTSProvider):
    ...
    def get_audio_bytes(self, text: str) -> bytes:
        ...
        kokoro = _get_kokoro_onnx()
        if kokoro is None:
            log("Kokoro ONNX chưa được khởi tạo, không thể sinh audio bytes.", title="TTS", style="bold red")
            return b""
        ...
        try:
            ...
            log(f"Lỗi khi tạo audio bytes Kokoro: {exc}", title="TTS", style="bold red")
            return b""